...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["uf0bd4970771f26a8cef66473d59bcc69"]
owner = ["uf0bd4970771f26a8cef66473d59bcc69"]
admin = ["uf0bd4970771f26a8cef66473d59bcc69"]
...
def help1():
    ...
    key = key.title()
    helpMessage1 = "☬ ชุดคำสั่งที่" + key + ".1 ☬\n\n" + \
                  "╠☬➣" + key + "คท\n" + \
                  "╠☬➣" + key + "ไอดี\n" + \
                  "╠☬➣" + key + "ไอดี「@」\n" + \
                  "╠☬➣" + key + "Steal「@」\n" + \
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2 = "☬ ชุดคำสั่งที่" + key + ".2 ☬\nตั้งค่า บันชีดำ\n\n" + \
                  "╠☬➣" + key + "Blc\n" + \
                  "╠☬➣" + key + "Ban:on\n" + \
                  "╠☬➣" + key + "Unban:on\n" + \
                  "╠☬➣" + key + "Ban「@」\n" + \
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        cl.sendMessage(msg.to," ☬สถานะ ข้อมูล☬\n\n☬➣ ชื่อ : " + msg.contentMetadata["displayName"] + "\n\n☬➣ ไอดี : " + msg.contentMetadata["mid"] + "\n\n☬➣ สถานะ / ตัส : " + contact.statusMessage + "\n\n☬➣ ลิ้งรูป : http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                else: md+="╠☬➣ เช็คสติกเกอร์  ❌\n"
                                if wait["contact"] == True: md+="╠☬➣ คท  ✔\n"
                                else: md+="╠☬➣ คท  ❌\n"
                                ...
                                if wait["autoAdd"] == True: md+="╠☬➣ รับเพื่อนอัตโนมัติ  ✔\n"
                                else: md+="╠☬➣ รับเพื่อนอัตโนมัติ  ❌\n"
                                ...
                                if wait["autoLeave"] == True: md+="╠☬➣ ออกแชทร่วม  ✔\n"
                                else: md+="╠☬➣ ออกแชทร่วม  ❌\n"
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                ret_ += "\n• ☬รายการโปรด ➣: {} Favorite".format(str(len(favoritelist)))
                                ret_ += "\n• ☬เวอร์ชั่น ➣: ☬รุ่นกันรัน PY3☬"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    query = msg.text.replace("สติกเกอร์: ", "")
                                    query = int(query)
                                    if type(query) == int:
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "「ข้อมูลกลุ่ม มีดังนี้」"
                                ret_ += "\n☬ชื่อกลุ่ม ➣ : {}".format(G.name)
                                ret_ += "\n☬ไอดีกลุ่ม ➣: {}".format(G.id)
                                ret_ += "\n☬ผู้สร้างกลุ่ม ➣ : {}".format(gCreator)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                for s in stream:
                                    ...
                                    author = '\n\n馃敯 Author : ' + str(vid.author)
                                    durasi = '\n馃敯 Duration : ' + str(vid.duration)
                                    suka = '\n馃敯 Likes : ' + str(vid.likes)
                                    rating = '\n馃敯 Rating : ' + str(vid.rating)
                                    deskripsi = '\n馃敯 Deskripsi : ' + str(vid.description)
...
#===========COMMAND ON OFF============#
                        ...
                        elif cmd == "เปิดแชร์" or text.lower() == 'เปิดแชร์':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = True
                                sendMention(msg.to, sender, "User ", "\n👌เปิดการอ่านลิ้งโพสต์ เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิดแชร์" or text.lower() == 'ปิดแชร์':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = False
                                sendMention(msg.to, sender, "User ", " \n👌ปิดการอ่านลิ้งโพสต์ เรียบร้อยแล้ว..❌")
                                
                        elif cmd == "เปิดเชิญ" or text.lower() == 'เปิดเชิญ':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = True
                                sendMention(msg.to, sender, "User ", "\n👌เปิดการเชิญ เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิดเชิญ" or text.lower() == 'ปิดเชิญ':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = False
                                sendMention(msg.to, sender, "User ", "\n👌ปิดการเชิญ เรียบร้อยแล้ว..❌")
                                
                        elif cmd == "เปิด เตะแทค" or text.lower() == 'เปิด เตะแทค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["mentionKick"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ เตะคนที่แทคเรา เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิด เตะแทค" or text.lower() == 'ปิด เตะแทค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["mentionKick"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ เตะคนแทค เรียบร้อยแล้ว..❌")

                        elif cmd == "เปิด คท" or text.lower() == 'เปิด คท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                sendMention(msg.to, sender, "User ", "\n👌เปิดการอ่าน ข้อมูลผู้ติดต่อ เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิด คท" or text.lower() == 'ปิด คท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to,"👌ปิดการอ่าน ข้อมูลผู้ติดต่อ เรียบร้อยแล้ว..❌")

                        elif cmd == "เปิดแทค" or text.lower() == 'เปิดแทค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ ตอบกลับแทค เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิดแทค" or text.lower() == 'ปิดแทค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ ตอบกลับแทค เรียบร้อยแล้ว..❌")

                        elif cmd == "เปิดเข้ากลุ่ม" or text.lower() == 'เปิดเข้ากลุ่ม':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ เข้ากลุ่มอัตโนมัติแล้ว...✔")

                        elif cmd == "ปิดเข้ากลุ่ม" or text.lower() == 'ปิดเข้ากลุ่ม':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ เข้ากลุ่มอัตโนมัติแล้ว..❌")

                        elif cmd == "เปิดออกแชท" or text.lower() == 'เปิดออกแชท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ ออกแชทร่วมอัตโนมัติแล้ว..✔")

                        elif cmd == "ปิดออกแชท" or text.lower() == 'ปิดออกแชท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ ออกแชทร่วมอัตโนมัติแล้ว..❌")

                        elif cmd == "เปิดเพิ่มเพื่อน" or text.lower() == 'เปิดเพิ่มเพื่อน':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ รับเพื่อนอัติโนมัติแล้ว..✔")

                        elif cmd == "ปิดเพิ่มเพื่อน" or text.lower() == 'ปิดเพิ่มเพื่อน':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ รับเพื่อนอัตโนมัติแล้ว..❌")

                        elif cmd == "เปิดบล็อค" or text.lower() == 'เปิดบล็อค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ บล็อคเพื่อนอัตโนมัติแล้ว..✔")

                        elif cmd == "ปิดบล็อค" or text.lower() == 'ปิดบล็อค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ บล็อคเพื่อนอัตโนมัติแล้ว..❌")

                        elif cmd == "Gcancel on" or text.lower() == 'Gcancel on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoCancel"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ ยกเลิกกลุ่มเชิญ ที่มีสมาชิกน้อยกว่าที่กำหนดโดยอัตโนมัติแล้ว..✔")

                        elif cmd == "Gcancel off" or text.lower() == 'Gcancel off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoCancel"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ ยกเลิกกลุ่มเชิญ ที่มีสมาชิกน้อยกว่าที่กำหนดโดยอัตโนมัติแล้ว..❌")

                        elif cmd == "เปิดติก" or text.lower() == 'เปิดติก':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = True
                                cl.sendText(msg.to,"👌เปิดระบบ ตรวจจับระหัส สติกเกอร์ เรียบร้อยแล้ว..✔")

                        elif cmd == "ปิดติก" or text.lower() == 'ปิดติก':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = False
                                cl.sendText(msg.to,"👌ปิดระบบ ตรวจจับระหัส สติกเกอร์ เรียบร้อยแล้ว..❌")
