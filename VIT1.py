...
wait = {
    ...
    "welcome":"ยินดีตอนรับ",
    "leave":"จะรีปไปไหน กลับมาก่อน",
    "comment":"[SELF BOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\nhttp://line.me/ti/p/9r-uE5EU09",
    "message":"[ตอบรับอัตโนมัติ]\n[SELF BOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\nhttp://line.me/ti/p/9r-uE5EU09",
    }
...
def welcomeMembers(to, mid):
    try:
        arrData = ""
        textx = "สวัสดี ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def help():
    ...
    key = key.title()
    helpMessage = "☬ ชุดคำสั่งที่" + key + ".1 ☬\n\n" + \
                  "╠☬➣" + key + "คท\n" + \
                  "╠☬➣" + key + "มิด「@」\n" + \
                  "╠☬➣" + key + "รูป「@」\n" + \
                  "╠☬➣" + key + "ปก「@」\n" + \
                  ...
                  "╠☬➣" + key + "เพิ่มmp3「Teks」\n" + \
                  "╠☬➣" + key + "ลบmp3「Teks」\n" + \
                  "╠☬➣" + key + "เพิ่มวีดีโอ「Teks」\n" + \
                  "╠☬➣" + key + "ลบวีดีโอ「Teks」\n" + \
                  "╠☬➣" + key + "เพิ่มติก「Teks」\n" + \
                  "╠☬➣" + key + "ลบติก「Teks」\n" + \
                  "╠☬➣" + key + "สแปมแทก:เว้นวรรค1ที ใส่ตัวเลข\n" + \
                  "╠☬➣" + key + "สแปมแทค 「@」\n" + \
                  "╠☬➣" + key + "สแปมคอล:  เว้นวรรค1ที ใส่ตัวเลข\n" + \
                  "╠☬➣" + key + "สแปมคอล\n" + \
                  "╠☬➣" + key + "Get-fs「Query」\n" + \
                  ...
                  "\n「 Setting Command」\n• Use「 " + key + " 」to Prefix\n\n" + \
                  "╠☬➣" + key + "เปิด/ปิดเตะแทก\n" + \
                  "╠☬➣" + key + "ป้องกันเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "กันลิ้งเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "กันเข้าเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "กันเตะเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "กันเชิญเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "กันยกเลิกเว้นวรรค1ที เปิด/ปิด\n" + \
                  "╠☬➣" + key + "เชิญคท/ปิดเชิญคท\n" + \
                  "╠☬➣" + key + "เปิด/ปิด สติกเกอร์\n" + \
                  "╠☬➣" + key + "Unsend「on/off」\n" + \
                  "╠☬➣" + key + "เปิด/ปิด ตอบแทก\n" + \
                  "╠☬➣" + key + "Timeline「on/off」\n" + \
                  "╠☬➣" + key + "เปิด/ปิด รับเพื่อน\n" + \
                  "╠☬➣" + key + "เปิด/ปิด คท\n" + \
                  "╠☬➣" + key + "เปิด/ปิดเข้ากลุ่ม\n" + \
                  "╠☬➣" + key + "เปิด/ปิด บล็อค\n" + \
                  "╠☬➣" + key + "คนเข้า เปิด/ปิด\n" + \
                  "╠☬➣" + key + "เปิด/ปิด ออกแชท\n" + \
                  "╠☬➣" + key + "เปิด/ปิดเข้าลิ้ง\n" + \
                  "\n「 Admin Command」\n• Use「 " + key + " 」to Prefix\n\n" + \
                  "╠☬➣" + key + "ตั้งบอท\n" + \
                  "╠☬➣" + key + "ล้างบอท\n" + \
                  "╠☬➣" + key + "ตั้งสตาฟ\n" + \
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "☬ ชุดคำสั่งที่" + key + ".2 ☬\n\n" + \
                  "╠☬➣" + key + "Blc\n" + \
                  "╠☬➣" + key + "ดำ @」\n" + \
                  "╠☬➣" + key + "ดำ1\n" + \
                  "╠☬➣" + key + "ล้างดำ「@」\n" + \
                  ...
                  "╠☬➣" + key + "เชคคนออก\n" + \
                  "╠☬➣" + key + "เชคคนแทก\n" + \
                  "╠☬➣" + key + "ตั้งสแกน:  เว้นวรรค1ที พิมข้อความ\n" + \
                  "╠☬➣" + key + "Set spam:「Text」\n" + \
                  "╠☬➣" + key + "คนแอด:  เว้น1ที พิมข้อความ\n" + \
                  "╠☬➣" + key + "คนแทค:  เว้น1ที พิมข้อความ\n" + \
                  "╠☬➣" + key + "คนเข้า:  เว้น1ที  พิมข้อความ\n" + \
                  "╠☬➣" + key + "คนออก:  เว้น1ที พิมข้อความ\n" + \
                  "╠☬➣" + key + "Myname:「Nama」\n" + \
                  "╠☬➣" + key + "Bot1name:「Nama」\n" + \
                  "╠☬➣" + key + "Bot2name:「Nama」\n" + \
                  "╠☬➣" + key + "Bot3name:「Nama」\n" + \
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "[ตอบรับ อัตโนมัติ]\n[SELF BOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\nhttp://line.me/ti/p/9r-uE5EU09")
                  cl.sendText(op.param1, wait["message"])
                  cl.sendContact(op.param1, "uf0bd4970771f26a8cef66473d59bcc69")
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ginfo = cl.getGroup(at)
                                ryan = cl.getContact(msg_dict[msg_id]["from"])
                                ret_ =  "รายการข้อความที่ถูกลบ\n"
                                ret_ += "• ผู้ส่ง : {}".format(str(ryan.displayName))
                                ret_ += "\n• ชื่อกลุ่ม : {}".format(str(ginfo.name))
                                ret_ += "\n• เวลาที่ส่งข้อตวาม : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in admin:
                           saints = cl.getContact(msg._from).displayName
                           cl.sendMessage(msg.to, saints +"\n" +wait["Respontag"])
               ...
               if msg.contentType == 0:
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "เปิดเซล":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                md = "\n[SELF BOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\n\n"
                                if wait["mentionKick"] == True: md+="╠☬➣  เตะคนแทค  ✔\n"
                                else: md+="╠☬➣  เตะคนแทค  ❌\n"
                                if wait["stickerOn"] == True: md+="╠☬➣  เชคสติกเกอร์  ✔\n"
                                else: md+="╠☬➣  เชคสติกเกอร์  ❌\n"
                                if wait["contact"] == True: md+="╠☬➣  ค.ท  ✔\n"
                                else: md+="╠☬➣  ค.ท  ❌\n"
                                if wait["talkban"] == True: md+="╠☬➣  พูดดำ  ✔\n"
                                else: md+="╠☬➣  พูดดำ  ❌\n"
                                if wait["unsend"] == True: md+="╠☬➣  ข้อความยกเลิก. ✔「เปิด」\n"
                                else: md+="╠☬➣  ข้อความยกเลิก  ❌\n"
                                if wait["detectMention"] == True: md+="╠☬➣  ตอบคนแทค  ✔\n"
                                else: md+="╠☬➣  ตอบคนแทค  ❌\n"
                                if wait["Timeline"] == True: md+="╠☬➣  ไทมไลน์  ✔\n"
                                else: md+="╠☬➣  ไทมไลน์  ❌\n"
                                if wait["autoJoin"] == True: md+="╠☬➣  เข้าร่วมกลุ่มอัตโนมัติ  ✔\n"
                                else: md+="╠☬➣  เข้าร่วมกลุ่มอัตโนมัติ  ❌\n"
                                if wait["autoCancel"]["on"] == True: md+="╠☬➣  ยกเลิกเกลุ่มที่มีสมาชิกต่ำกว่า  " + str(settings["autoCancel"]["members"]) + " ✔\n"
                                else: md+= "╠☬➣  ยกเลิกเชิญกลุ่ม  ❌\n"
                                if wait["autoAdd"] == True: md+="╠☬➣  รับเพื่อนออโต้  ✔\n"
                                else: md+="╠☬➣  รับเพื่อนออโต้  ❌\n"
                                if wait["autoBlock"] == True: md+="╠☬➣  ออโต้บล็อค  ✔\n"
                                else: md+="╠☬➣  ออโต้บล็อค  ❌\n"
                                if settings["autoJoinTicket"] == True: md+="╠☬➣  เข้าลิ้งอัตโนมัติ  ✔\n"
                                else: md+="╠☬➣  เข้าลิ้งอัตโนมัติ  ❌\n"
                                if msg.to in welcome: md+="╠☬➣  คำตอนรับ  ✔\n"
                                else: md+="╠☬➣  คำตอนรับ  ❌\n"
                                if wait["leave"] == True: md+="╠☬➣ Leave  ✔\n"
                                else: md+="╠☬➣ Leave  ❌\n"
                                if wait["autoLeave"] == True: md+="╠☬➣  ออกแชท  ✔\n"
                                else: md+="╠☬➣  ออกแชท  ❌\n"
                                if msg.to in protectqr: md+="╠☬➣  กันลิ้ง  ✔\n"
                                else: md+="╠☬➣  กันลิ้ง  ❌\n"
                                if msg.to in protectjoin: md+="╠☬➣. กันคนเข้ากลุ่ม  ✔\n"
                                else: md+="╠☬➣  กันคนเข้ากลุ่ม  ❌\n"
                                if msg.to in protectkick: md+="╠☬➣  กันคนเตะสมาชิก  ✔\n"
                                else: md+="╠☬➣  กันคนเตะสมาชิก  ❌\n"
                                if msg.to in protectinvite: md+="╠☬➣  กันเชิญ  ✔\n"
                                else: md+="╠☬➣ กันเชิญ  ❌\n"
                                if msg.to in protectcancel: md+="╠☬➣. กันยกเชิญ  ✔\n"
                                else: md+="╠☬➣  กันยกเชิญ  ❌\n"
                        ...
                        elif cmd == "เชคแอด" or text.lower() == 'เช็คแอด':
                            if msg._from in admin:
                                cl.sendText(msg.to,"「Created by : ™[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                text = xpesan + zxc + ret_ + ""
                                cl.sendMessage(to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                                cl.sendContact(to, "uf0bd4970771f26a8cef66473d59bcc69")
                            except Exception as e:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "สถานะรีบูต\nUser ", "\nบอทรีบูตสำเร็จ")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                sendMention1(msg.to, sender, "「Bye bye」 ", " So sad :v")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                sw.sendText(msg.to, "Bye bye "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "ระบบเริ่มนับคนอ่าน\nถ้าจะดูคนอ่านพิม ใครแอบ\n\n• เวลา [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• วันที่ : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            if msg.to in Setmain['RAreadPoint']:
                                ...
                                cl.sendText(msg.to, "ขณะนี้ไม่มีคนอ่าน")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "ดูคนอ่าน\nดูคนอ่านอัตโนมัติเปิดทำงาน\n\n• Time [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "ดูคนอ่าน\nดูคนอ่านอัตโนมัติปิดทำงาน\n\n• Time [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
                              else:
                                  cl.sendMessage(msg.to, "ขณะนี่ยังไม่มีคนอ่าน")
                          ...
                          if msg._from in admin:
                           ...
                           if msg._from in admin:
                             if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                try:
                                    ...
                                    cl.sendMessage(msg.to, "แปลงร่างสำเร็จ")
                           ...
                           if msg._from in admin:
                              try:
                                  ...
                                  cl.sendMessage(msg.to, "กลับคืนร่างเดิมสำเร็จ")

                        elif cmd.startswith("สแปมแทค: "):
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                proses = text.split(":")
...
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name not in images:
                                ...
                                cl.sendText(msg.to, "Foto ถูกเพิ่มในรายการแล้ว") 
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                cl.sendText(msg.to, "Foto ถูกลบออกจากรายการแล้ว") 
                                 
                        elif text.lower() == "รายการรูป":
                           if msg._from in admin:
                             no = 0
                             ret_ = "「 Daftar Image 」\n\n"
                             for image in images:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name not in videos:
                                ...
                                cl.sendText(msg.to, "Video ถูกเพิ่มในรายการแล้ว") 
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                cl.sendText(msg.to, "Video ถูกลบออกจากรายการแล้ว") 
                                 
                        elif text.lower() == "รายการวีดีโอ":
                           if msg._from in admin:
                             no = 0
                             ret_ = "「 Daftar Video 」\n\n"
                             for video in videos:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name not in audios:
                                ...
                                cl.sendText(msg.to, "Mp3 ถูกเพิ่มในรายการแล้ว") 
                                
                        elif cmd.startswith("ลบmp3 "):
                          if msg._from in admin:
                            sep = text.split(" ")
                            name = text.replace(sep[0] + " ","")
                            name = name.lower()
                            if name in audios:
                                ...
                                cl.sendText(msg.to, "Mp3 ถูกลบออกจากรายการแล้ว") 
                                 
                        elif text.lower() == "รายการmp3":
                           if msg._from in admin:
                             no = 0
                             ret_ = "「 Daftar Lagu 」\n\n"
                             for audio in audios:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name not in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "ส่งสติกเกอร์ที่้ต้องการเพิ่มลงมา...") 
                            else:
                                cl.sendText(msg.to, "สติกเกอร์ถูกเพิ่มในรายการเรียบร้อยแล้ว") 
                                
                        elif cmd.startswith("ลบติก "):
                          if msg._from in admin:
                            sep = text.split(" ")
                            name = text.replace(sep[0] + " ","")
                            name = name.lower()
                            if name in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "ลบสติกเกอร์เรียบร้อยแล้ว {}".format( str(name.lower())))
                            else:
                                cl.sendText(msg.to, "ไม่มีสติกเกอร์นี้อยู่ในรายการ") 
                                 
                        elif text.lower() == "รายการติก":
                           if msg._from in admin:
                             no = 0
                             ret_ = "「 Daftar Sticker 」\n\n"
                             for sticker in stickers:
...
#===========Protection============#
                        elif 'ตอนรับ ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('ตอนรับ ','')
                              if spl == 'เปิด':
                                  if msg.to in welcome:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "สถานะ : < เปิด >\nเข้ากลุ่ม : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "คำตอบรับคนเข้ากลุ่ม\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in welcome:
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'เปิด':
                                  ...
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันคนยุ่งเกี่ยวลิ้งแล้ว\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectqr:
                                    ...
                                    cl.sendMessage(msg.to, "ปิดระบบป้องกันคนยุ่งเกี่ยวลิ้งแล้ว\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'เปิด':
                                  if msg.to in protectkick:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "สถานะ : < เปิด >\nIn Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันคนเตะสมาชิกแล้ว\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectkick:
                                    ...
                                    cl.sendMessage(msg.to, "ปิดระบบป้องกันคนเตะสมาชิกแล้ว\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'เปิด':
                                  if msg.to in protectjoin:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "สถานะ : < เปิด >\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันบุคคลภายนอกเข้ากลุ่มแล้ว\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectjoin:
                                    ...
                                    cl.sendMessage(msg.to, "ปิดระบบป้องกันบุคคลภายนอกเข้ากลุ่มแล้ว\n" + msgs)

                        elif 'กันยกเลิก ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('กันยกเลิก ','')
                              if spl == 'เปิด':
                                  if msg.to in protectcancel:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "สถานะ : < เปิด >\nIn Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันการยกเลิกคำเชิญแล้ว\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel has been enabled"
                                    cl.sendMessage(msg.to, "ปิดระบบป้องกันการยกเลิกคำเชิญแล้ว\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'เปิด':
                                  if msg.to in protectinvite:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "สถานะ : < เปิด >\nIn Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันการเชิญเพื่อนแล้ว\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite has been disabled"
                                    cl.sendMessage(msg.to, "ปิดระบบป้องกันการเชิญเพื่อนแล้ว\n" + msgs)

                        elif 'ป้องกัน ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('ป้องกัน ','')
                              if spl == 'เปิด':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "สถานะ : < เปิด >\nIn Group : " +str(ginfo.name)
                                      msgs += "\nเปิดระบบป้องกันการเชิญ !"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "สถานะ : < เปิด >\nIn Group : " +str(ginfo.name)
                                      msgs += "\nเปิดระบบป้องกันการยกเลิกเชิญ !"
                                  cl.sendMessage(msg.to, "เปิดระบบป้องกันเต็มรูปแบบ\n" + msgs)
                              elif spl == 'ปิด':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    else:
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"เพิ่มแอดมินสำเร็จ")
                                       except:
                                           pass

                        elif ("เพิ่มสตาฟ " in msg.text):
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               key = eval(msg.contentMetadata["MENTION"])
                               key["MENTIONEES"][0]["M"]
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"เพิ่มสตาฟสำเร็จ")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"เพิ่มแบอทำเร็จ")
                                       except:
                                           pass
                        ...
                        elif cmd == "ตั้งแอด" or text.lower() == 'admin:on':
                            if msg._from in admin:
                                wait["addadmin"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะเป็นแอดมินลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "ล้างแอด" or text.lower() == 'admin:expell':
                            if msg._from in admin:
                                wait["delladmin"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะล้างแอดมินลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "ตั้งสตาฟ" or text.lower() == 'staff:on':
                            if msg._from in admin:
                                wait["addstaff"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะเป็นสตาฟลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "ล้างสตาฟ" or text.lower() == 'staff:expell':
                            if msg._from in admin:
                                wait["dellstaff"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะล้างสตาฟลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "ตั้งบอท" or text.lower() == 'bot:on':
                            if msg._from in admin:
                                wait["addbots"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะเป็นบอทลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "ล้างบอท" or text.lower() == 'bot:expell':
                            if msg._from in admin:
                                wait["dellbots"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคคนที่จะล้างบอทลงมา,\nเสร็จแล้ว อย่าลืมพิม รีเฟช")

                        elif cmd == "รีเฟช" or text.lower() == 'refresh':
                            if msg._from in admin:
                                wait["addadmin"] = False
                        ...
                        elif cmd == "คทสตาฟ" or text.lower() == 'contact staff':
                            if msg._from in admin:
                                ma = ""
                                for i in staff:
                                    ma = cl.getContact(i)
...
#===========COMMAND ON OFF============#
                        ...
                        elif cmd == "เชิญคท" or text.lower() == 'invite on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = True
                                sendMention(msg.to, sender, "「 Status Invite 」\nUser ", "\nSend a contact to invite,\nIf done -> Invite off")

                        elif cmd == "ปิดเชิญคท" or text.lower() == 'invite off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = False
                                sendMention(msg.to, sender, "ปิดระบบการเชิญด้วยคอนแทค")
                                
                        elif cmd == "เปิดเตะแทค" or text.lower() == 'notag on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["mentionKick"] = True
                                cl.sendText(msg.to,"สถานะเตะคนแทก\nถูกเปิดใช้งาน")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                sendMention(msg.to, sender, "เปืดดูคอนแทค\nUser ", "\nส่งคอนแทคที่จะดูข้อมูลลงตามมา")

                        elif cmd == "ปิดคท" or text.lower() == 'contact off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to,"ปืดดูคอนแทค\nระบบปืดดูคอนแทคแล้ว")

                        elif cmd == "เปิดตอบแทค" or text.lower() == 'respon on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = True
                                cl.sendText(msg.to,"สถานะตอบคนแทก\nถูกเปิดใช้งานแล้ว")

                        elif cmd == "ปิดตอบแทค" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"เปิดระบบเข้าร่วมกลุ่มอัตโนมัติ")

                        elif cmd == "ปิดเข้ากลุ่ม" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"ปิดระบบเข้าร่วมกลุ่มอัตโนมัติ")

                        elif cmd == "เปิดออกแชท" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"ระบบปฏิเสธการเข้าแชทรวมเปิดทำงาน")

                        elif cmd == "ปิดออกแชท" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"ระบบปฏิเสธการเข้าแชทรวมปิดทำงาน")

                        elif cmd == "เปิดบล็อค" or text.lower() == 'block on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"ระบบออโต้บลอคเริ่มทำงาน")

                        elif cmd == "ปิดบล็อค" or text.lower() == 'block off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"ระบบออโต้บลอคหยุดทำงาน")

                        elif cmd == "เปิดรับเพื่อน" or text.lower() == 'add on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoadd"] = True
                                cl.sendText(msg.to,"ระบบรับเพื่อนอัตโนมัติ\nเปิดทำงานแล้ว")

                        elif cmd == "ปิดรับเพื่อน" or text.lower() == 'add off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoadd"] = False
                                cl.sendText(msg.to,"ระบบรับเพื่อนอัตโนมัติ\nปิดทำงานแล้ว")

                        elif cmd == "เปิดติก" or text.lower() == 'sticker on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = True
                                sendMention(msg.to, sender, "「 Status Sticker Check 」\n", "  <ON >\nPlease send a sticker,\nIf done , -> sticker off")

                        elif cmd == "ปิดติก" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["stickerOn"] = False
                                cl.sendText(msg.to,"「 Status Sticker Check 」\nSticker check has been disabled")

                        elif cmd == "เปิดเข้าลิ้ง" or text.lower() == 'jointicket on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = True
                                sendMention(msg.to, sender, "เปิดระบบการเข้าร่วมกลุ่มทางลิ้งอัตโนมัติ\nUser ", "\nส่งลิ้งกลุ่มมาทางแชท")

                        elif cmd == "ปิดเข้าลิ้ง" or text.lower() == 'jointicket off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = False
                                cl.sendText(msg.to,"ปิดระบบการเข้าร่วมกลุ่มทางลิ้งอัตโนมัติ")

#===========COMMAND BLACKLIST============#
                        elif ("พูดดำ " in msg.text):
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               key = eval(msg.contentMetadata["MENTION"])
                               key["MENTIONEES"][0]["M"]
                        ...
                        elif cmd == "พูดดำ1" or text.lower() == 'talkban:on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Talkwblacklist"] = True
                                sendMention(msg.to, sender, "", "\nSend a contact,\nIf done , don't forget to Refresh !")

                        elif cmd == "ล้างพูดดำ1" or text.lower() == 'untalkban:on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Talkdblacklist"] = True
                                sendMention(msg.to, sender, "", "\nSend a contact ,\nIf done , don't forget to Refresh !")

                        elif ("ดvfxำ " in msg.text):
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               key = eval(msg.contentMetadata["MENTION"])
                               key["MENTIONEES"][0]["M"]
                        ...
                        elif cmd == "ดำ1" or text.lower() == 'ban:on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["wblacklist"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคของคนที่จะติดดำลงมา,\nเสร็จแล้วอย่าลืมพิมคำว่า รีเฟช !")

                        elif cmd == "ล้างดำ1" or text.lower() == 'unban:on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["dblacklist"] = True
                                sendMention(msg.to, sender, "", "\nส่งคอนแทคของคนที่จะล้างดำลงมา,\nเสร็จแล้วอย่าลืมพิมคำว่า รีเฟช !")
                        ...
                        elif cmd == "เชคพูดดำ" or text.lower() == 'talkbanlist':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "ล้าdxงดำ" or text.lower() == 'clearban':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                  wait["blacklist"] = {}
                                  ragets = cl.getContact(wait["blacklist"])
                                  mc = "「%i」User Blacklist" % len(ragets)
                                  cl.sendMessage(msg.to,"ล้างบัญชีดำให้ทุกคนเรียบร้อยแล้ว\n" +mc)                         
#===========COMMAND SET============#
                        elif 'คนแอด: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('คนแอด: ','')
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Gagal mengganti Pesan Msg")
                              else:
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "ตั้งค่าสำเร็จ\nข้อความตอบกลับถึงคนแอดคือคำนี้\n\n{}".format(str(spl)))
                        ...
                        elif 'คนแทค: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('คนแทค: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif 'ตั้งสแกน: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('ตั้งสแกน: ','')
                              if spl in [""," ","\n",None]:
